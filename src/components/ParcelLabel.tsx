        ...
        <div className="labelBorder">
          <Row>
              ...
              <div className="sender">
                <Row>
                  ...
                  <Col
                    ...
                    {data.serviceName ? data.serviceName : 'Postipaketti'}
                  </Col>
                </Row>
                <Row>
                  <div
                    className="sender-label label"
                    data-toggle="tooltip"
                    data-placement="top"
                    data-container=".labelPreview"
            ...
            <Col className="middle" xs={3}>
              <Row>
                <div
                  ...
                  data-placement="top"
                  data-container=".labelPreview"
                  title="<b>The service's process number</b></br>Mandatory: Yes</br>Font size: 20/24 bold</br>Description: Grouped according to the service-specific models">
                  16
                </div>
              </Row>
              <Row>
                <Col
                  ...
                  data-placement="top"
                  data-container=".labelPreview"
                  title="The recipient's mobile phone number and/or email address has to be given in the EDI message."
            ...
            <Col xs={4} className="product">
              <Row>
                <div
                  className="serviceBarcode"
                  data-toggle="tooltip"
                  data-placement="top"
                  data-container=".labelPreview"
                  title="<b>The service's product code as a barcode</b></br>Mandatory: Yes</br>6 characters, contain a technical modulo 103 check digit, not visual</br>FactCode: 2W</br>Product code: 4 numbers given by Posti</br>Bar code type: Licence Plate code 128 a, b and c</br>The first two characters shall produced in type a or b and the remaining four even numbersin type c. It is not mandatory to use type c, if in the address label is space enough to print out longer bar code.</br>X-value (width of the narrowest bar) 0,42 -0,50 mm (optimal value is 0,46 mm)</br>The minimum resolution in thermal transfer printer is 200 dots / inch.</br>The minimum resolution in laser reproduction is 600 dots / inch.</br>Free space at both sides of the bar code must be at least 5 mmoMinimum height is 20 mm, but when EDI-message is used 12 mm </br>Use block capitals in bar codes">
                  <Barcode value="2W2103" displayValue={false} height="70" width="2" />
                </div>
              </Row>
              <Row>
                <div
                  ...
                  data-placement="top"
                  data-container=".labelPreview"
                  title="<b>The service's product code</b></br>Mandatory: Yes</br>Font size: 10</br>Description: The service's product code that uses the License Plate 2W -prefix">
                  2W2103
                </div>
              </Row>
              <Row>
                ...
                <Col className="weight box">
                  <Row>
                    <Col
                      ...
                      data-placement="top"
                      data-container=".labelPreview"
                      title="<b>Shipment gross weight</b></br>Mandatory: No</br>Font size: 8</br>Description: Shipment gross weight">
                      0,31
                    </Col>
                    <Col
                      xs={2}
                ...
                <Col className="volume box">
                  <Row>
                    <Col
                      ...
                      data-placement="top"
                      data-container=".labelPreview"
                      title="<b>Shipment volume</b></br>Mandatory: No</br>Font size: 8</br>Description: Shipment volume"></Col>
                    <Col
                      xs={2}
          ...
          <Row>
            <Col xs={8} className="codReference box">
              <Row>
                <div className="addon-label label">Pankkiviite Bankreferens</div>
              </Row>
              <Row>
